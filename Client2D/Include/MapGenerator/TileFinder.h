...
public:
	...
	int Check_NearTileState4(Vector2 Index, TILE_STATE checkTileState, class CMapGenerator* pCurrentMapGenerator);
	...
	std::vector<Vector2> GetNearTileState4(Vector2 Index, TILE_STATE checkTileState, class CMapGenerator* pCurrentMapGenerator);
